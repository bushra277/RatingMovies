...
void main(){
  var user1 = User(username : 'Ahmad' , email : 'ahmad222@yahoo.com');
  var user2 = User(username : 'Omar' , email : 'omarhh33@yahoo.com');
  var user3 = User(username : 'Bushra' , email : 'bushraahmad44@yahoo.com');

  var movie1 = Movie(title : 'Inception' , genre: 'Science Fiction' , release_year: 2010 , director: 'Christopher Nolan');
  var movie2 = Movie(title : 'Titanic' , genre: 'Romance/ Drama' , release_year: 1997 , director: 'James Cameron');
  var movie3 = Movie(title : 'Parasite' , genre: 'Thriller / Drama' , release_year: 2019, director: 'Bong Joon-ho');
  ...
  movie3.movieRating(9);

  user3.show_my_ratings();
